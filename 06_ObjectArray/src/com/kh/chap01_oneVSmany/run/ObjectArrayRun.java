...
import com.kh.chap01_oneVSmany.model.vo.*;
...
public class ObjectArrayRun {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println(books[0].information()); } if
		 * (search.equals(books[1].getTitle())) {
		 * System.out.println(books[1].information()); } if
		 * (search.equals(books[2].getTitle())) {
		 * System.out.println(books[2].information()); }
		 */
		for (int i = 0; i < books.length; i++) {
