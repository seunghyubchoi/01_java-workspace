...
public class ListRun {
	 ...
	 * 
	 * 1. 배열은 우선 크기를 지정해야됨!! 한번 지정된 크기를 변경 할 수가 없음 
	 * 2. 배열 중간에 추가한다거나 삭제하는 경우 매번 땡겨주는 복잡한 알고리즘을 직접 기술해야 됨 
	 * 3.한 공간에 한 타입의 데이터들만 저장 가능 새로운 값을 더 추가하고자 한다면 새로운 크기의 배열을 만들고 기존꺼를 복사하는 코드를 직접 기술
	 * 
	 * 컬렉션 장점 
	 ...
	 * * 방대한 데이터들을 보관하고 추가 삭제 등등 이런 과정들이 빈번할 경우 컬렉션을 많이 사용
	 * 
	 */
