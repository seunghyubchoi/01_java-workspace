...
public class WrapperRun {
	...
	public static void main(String[] args) {
		 ...
		 * => 객체로 취급하면 좋은 점 : 메소드 호출 가능 
		 * => 메소드를 호출해야 할 때 => 메소드의 매개변수로 기본자료형이 아닌 객체타입만이 요구 될 때 
		 * => 다형성을 적용시키고 싶을 때
		 * 
		 */
		...
		System.out.println("i1.compareTo(i2) : " + i1.compareTo(i2)); // 두 값을 비교해서 앞쪽이 크면 1, 뒤쪽이 크면 -1, 같으면 0 출력
