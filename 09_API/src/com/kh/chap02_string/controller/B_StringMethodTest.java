...
public class B_StringMethodTest {
	public void method() {
		...
		// 메소드명(매개변수) : 반환형
		System.out.println("1. 문자열.charAt(int index) : char");
		...
		System.out.println();
		System.out.println("3. 문자열.equals(Object obj) : boolean return");
		...
		System.out.println();
		System.out.println("4. 문자열.contains(CharSequence s) : boolean");
		...
		System.out.println();
		System.out.println("5. 문자열.length() : int");
		// 5. 문자열.length() : int
		...
		System.out.println("7. 문자열.replace(char oldChar, char newChar) : String");
		...
		System.out.println();
		System.out.println("8. 문자열.toUpperCase() : String");
		...
		/*
		 * System.out.print("계속하시겠습니까? (y/n) : "); char ch = sc.nextLine().charAt(0);
		 * 
		 * if(ch == 'n' || ch == 'N') { 프로그램 종료 }
		 * 
		 * char ch = sc.nextLine().toUpperCase().charAt(0); if(ch == 'N') { 프로그램 종료 }
		 * 
		 * char ch = sc.nextLine().charAt(0).toUpperCase(); => 이런 포맷은 안 됨 = String 클래스에서
		 * 제공하는 함수임, toUpper는 String에서만 사용 가능
		 */
		System.out.println();
		System.out.println("9. 문자열.trim() : String");
		// 9. 문자열.trim() : String(얘 많이 씀)
		// 문자열 앞 뒤 공백을 제거시킨 새 문자열 리턴
		String str6 = "   JA   VA   ";
		System.out.println("str6 :" + str6.trim());
		System.out.println();
		System.out.println("10. 문자열.toCharArray() : char[]");
